...
// v3 Card — hairline border, modest shadow, tighter radius.
// Padding: comfortable on desktop (p-5), denser on mobile (p-4).
...
const CardTitle = React.forwardRef(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      'text-base leading-tight tracking-tight font-emphasis text-foreground',
      className
    )}
    {...props}
  />
